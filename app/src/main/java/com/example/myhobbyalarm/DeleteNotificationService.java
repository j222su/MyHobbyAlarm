...
public class DeleteNotificationService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        storeRetrieveData = new StoreRetrieveData(this, CalendarFragment.FILENAME);
    ...
    private void dataChanged() {
        SharedPreferences sharedPreferences = getSharedPreferences(CalendarFragment.SHARED_PREF_DATA_SET_CHANGED, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putBoolean(CalendarFragment.CHANGE_OCCURED, true);
        editor.apply();
    }
